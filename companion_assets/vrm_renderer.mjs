...
`)}var Ex={[lu]:"Linear",[cu]:"Reinhard",[uu]:"Cineon",[hu]:"ACESFilmic",[fu]:"AgX",[pu]:"Neutral",[du]:"Custom"};function Sx(i,e){let t=Ex[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var Hl=new M;function Tx(){Xe.getLuminanceCoefficients(Hl);let i=Hl.x.toFixed(4),e=Hl.y.toFixed(4),t=Hl.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}var Bx={[ho]:"SHADOWMAP_TYPE_PCF",[ss]:"SHADOWMAP_TYPE_VSM"};function Dx(i){return Bx[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var Ux={[Oi]:"ENVMAP_TYPE_CUBE",[cr]:"ENVMAP_TYPE_CUBE",[fo]:"ENVMAP_TYPE_CUBE_UV"};function Fx(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Ux[i.envMapMode]||"ENVMAP_TYPE_CUBE"}var Ox={[cr]:"ENVMAP_MODE_REFRACTION"};function Vx(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Ox[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}var Hx={[au]:"ENVMAP_BLENDING_MULTIPLY",[_f]:"ENVMAP_BLENDING_MIX",[Af]:"ENVMAP_BLENDING_ADD"};function kx(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Hx[i.combine]||"ENVMAP_BLENDING_NONE"}function zx(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Gx(i,e,t,n){let r=i.getContext(),s=t.defines,o=t.vertexShader,a=t.fragmentShader,l=Dx(t),c=Fx(t),u=Vx(t),h=kx(t),d=zx(t),f=bx(t),p=wx(s),_=r.createProgram(),m,g,T=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(Eo).join(`
`)),o=Hu(o),o=Jf(o,t),o=Kf(o,t),a=Hu(a),a=Jf(a,t),a=Kf(a,t),o=$f(o),a=$f(a),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
